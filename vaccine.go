...
//==============================================================================================================================
//	e - Defines the structure for a car object. JSON on right tells it what JSON fields to map to
...
type Vehicle struct {
	...
	Model           string `json:"model"` //Type of Vaccine
	Reg             string `json:"reg"`
	VIN             int    `json:"VIN"`  //BARCODE
	Owner           string `json:"owner"`
	Scrapped        bool   `json:"scrapped"` //Dispose of Vaccive
...
// Retrieve Temperature log for an RFID
func (t *SimpleChaincode) retrieve_temp(stub *shim.ChaincodeStub, v5cID string) (Vehicle, error) {
